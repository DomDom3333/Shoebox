...
/// </summary>
public class PoolAccessService(IDataProtectionProvider dataProtection, IOptions<GroupPhotoOptions> options)
{
    private const string AccessCookie = "gp_access";
    private const string AdminCookie = "gp_admin";

    private readonly IDataProtector _protector = dataProtection.CreateProtector("GroupPhoto.PoolAccess.v1");
